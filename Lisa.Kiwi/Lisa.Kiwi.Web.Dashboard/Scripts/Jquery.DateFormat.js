...
*
*   Usage: 
*   - Change format:            $.format.date(Date, format)
*   - To browser Time Zone:     $.format.toBrowserTimeZone(utcDate, format)
*   - Pretty Date (x time ago): $.format.prettyDate(date)
*
*   IMPORTANT - IMPORTANT - IMPORTANT - IMPORTANT - IMPORTANT - IMPORTANT - IMPORTANT   - IMPORTANT
*
*   IMPORTANT -         The (utc)date needs one of the following formats:               - IMPORTANT
*   IMPORTANT -         1 MMMM dd, yyyy (October 28, 1994)                              - IMPORTANT                                       
*   IMPORTANT -         2 MMMM dd, yyyy HH:mm (October 28, 1994 10:25)                  - IMPORTANT
*   IMPORTANT -         3 MMMM dd, yyyy HH:mm:ss (October 28, 1994 10:25:59)            - IMPORTANT
*
*   IMPORTANT - IMPORTANT - IMPORTANT - IMPORTANT - IMPORTANT - IMPORTANT - IMPORTANT   - IMPORTANT
*/
...
(function ($) {
    ...
    switch (language) {
        case 'nl':
            ...
            shortDaysInWeek = ['zo', 'ma', 'di', 'wo', 'do', 'vr', 'za'];
            shortMonthsInYear = ['jan', 'feb', 'mrt', 'apr', 'mei', 'jun',
                                        'jul', 'aug', 'sep', 'okt', 'nov', 'dec'];
            longMonthsInYear = ['januari', 'februari', 'maart', 'april', 'mei', 'juni',
