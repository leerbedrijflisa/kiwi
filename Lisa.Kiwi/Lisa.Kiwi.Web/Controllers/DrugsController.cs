...
namespace Lisa.Kiwi.Web.Reporting.Controllers
{
    public class DrugsController : Controller
    {
		...
		private readonly Proxy<Report> _reportProxy = new Proxy<Report>("http://locahost:20151", "/reports/");
        private readonly Proxy<Contact> _contactProxy = new Proxy<Contact>("http://locahost:20151", "/reports/");
	}
}