...
namespace Lisa.Kiwi.Web
{
    public class ContactViewModel
    {
        ...
        [RequiredIf("IsNullOrWhiteSpace(EmailAddress)", ErrorMessageResourceName = "PhoneOrEmail", ErrorMessageResourceType = typeof(ErrorMessages))]
        [MinLength(4, ErrorMessageResourceName = "PhoneNumber", ErrorMessageResourceType = typeof(ErrorMessages))]
        public string PhoneNumber { get; set; }

        [RequiredIf("IsNullOrWhiteSpace(PhoneNumber)", ErrorMessageResourceName = "PhoneOrEmail", ErrorMessageResourceType = typeof(ErrorMessages))]
